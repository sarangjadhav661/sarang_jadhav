                    ...
                    <div className="container">
                        ...
                        <div className="collapse navbar-collapse" id="navbarCollapse" >
                            <div className="navbar-nav">
                                <a href="/user" className="nav-item nav-link active fw-bolder myHover" style={{letterSpacing : '1px'}}
                                >Home</a>
                            </div>
                            <div className="navbar-nav">
                                <a href="/Contact" className="nav-item nav-link active fw-bolder myHover ms-2" style={{letterSpacing : '1px'}}
                                >Contact</a>
                            </div>
                          
                            <div className="navbar-nav ms-auto">
                                <a className="nav-item nav-link active fw-bolder  text-success" style={{letterSpacing : '1px'}} >User</a>
                            </div>
